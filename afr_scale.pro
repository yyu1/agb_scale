...
in_h_file = '/Volumes/Global_250m/output/afr/v3/maxent_afr_hlorey_v3_filled_9.6sec.flt'
in_hv_file = '/Volumes/ALOS_01/global_alos_2007/afr/afr_3.2sec_HV_mosaic'
in_rfdi_file = '/Volumes/ALOS_01/global_alos_2007/afr/afr_3.2sec_RFDI.flt'

out_file = '/Volumes/Global_250m/output/afr/v3/3.2sec/maxent_afr_hlorey_3.2sec_v1.flt'
...
for j=0ULL, ydim-1 do begin
	...
	;readu, 2, in_hh_line
	readu, 3, in_hv_line
	in_hv_line = in_hv_line * in_hv_line ; square to get sigma0 numbers
