...
in_h_file = '/Volumes/Global_250m/output/sam/v3/maxent_sam_hlorey_using_newprior_9.6sec_fuzzy.flt'
;in_hh_file = '/Volumes/Global_250m/alos/3.2sec/sam/sam_3.2sec_HV_slice.flt'
in_hv_file = '/Volumes/ALOS_01/global_alos_2007/sam/sam_3.2sec_HV_mosaic_sqr.flt'
in_rfdi_file = '/Volumes/ALOS_01/global_alos_2007/sam/sam_3.2sec_RFDI.flt'

out_file = '/Volumes/Global_250m/output/sam/v3/3.2sec/maxent_sam_hlorey_3.2sec_v1.flt'
